...
self.onmessage = function(e) {
  ...
  let result;
  if (msg.type === "encode") {
    result = import_lz_string.default.compressToEncodedURIComponent(msg.value);
  } else if (msg.type === "decode") {
    result = import_lz_string.default.decompressFromEncodedURIComponent(msg.value);
  } else {
    throw new Error(`Unknown request message type: ${msg.type}`);
  }
